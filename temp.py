...
parser.add_argument('--load_from',default="2D_patch_test")
...
singan_generated = generate(generators[0:len(generators)-2], 'reconstruct', opt, opt['device'])
imageio.imwrite("full.png", singan_generated.detach().cpu().numpy()[0].swapaxes(0,2).swapaxes(0,1))
